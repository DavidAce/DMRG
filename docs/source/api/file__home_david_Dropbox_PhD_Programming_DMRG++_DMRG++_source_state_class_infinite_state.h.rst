...
.. _file__home_david_Dropbox_PhD_Programming_DMRG++_DMRG++_source_state_class_infinite_state.h:

File class_infinite_state.h
===========================
...
Definition (``/home/david/Dropbox/PhD/Programming/DMRG++/DMRG++/source/state/class_infinite_state.h``)
------------------------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file__home_david_Dropbox_PhD_Programming_DMRG++_DMRG++_source_state_class_infinite_state.h.rst
...
- :ref:`exhale_class_classclass__infinite__state`
