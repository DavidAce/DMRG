...
.. _file__home_david_Dropbox_PhD_Programming_DMRG++_DMRG++_source_general_nmspc_random_numbers.h:

File nmspc_random_numbers.h
===========================
...
Definition (``/home/david/Dropbox/PhD/Programming/DMRG++/DMRG++/source/general/nmspc_random_numbers.h``)
--------------------------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file__home_david_Dropbox_PhD_Programming_DMRG++_DMRG++_source_general_nmspc_random_numbers.h.rst
...
- ``random`` (:ref:`file__home_david_Dropbox_PhD_Programming_DMRG++_DMRG++_source_general_nmspc_random_numbers.cpp`)
