...
.. _file__home_david_Dropbox_PhD_Programming_DMRG++_DMRG++_source_model_class_model_base.h:

File class_model_base.h
=======================
...
Definition (``/home/david/Dropbox/PhD/Programming/DMRG++/DMRG++/source/model/class_model_base.h``)
--------------------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file__home_david_Dropbox_PhD_Programming_DMRG++_DMRG++_source_model_class_model_base.h.rst
...
- :ref:`exhale_class_classclass__model__base`
