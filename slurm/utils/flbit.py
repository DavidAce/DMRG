        ...
        try:
            with h5py.File(filename, 'r') as h5file:
                ...
                if optional_attrs[0] is not None: # Check the initial pattern
                    ...
                    should_be_neel = 'neel' in filename or 'lbit93-precision' in filename or '-lin' in filename or 'lbit116' in filename or 'lbit117' in filename or 'lbit118' in filename or 'lbit119' in filename or 'lbit120' in filename
                    if should_be_neel and not has_neel_init_pattern:
