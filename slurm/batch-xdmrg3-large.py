...
config_ranges = {
    ...
    "console::loglevel": ['2'],
    "precision::eigs_iter_min" :["200"],
    "precision::eigs_iter_max" :["25000"],
    "precision::eigs_iter_gain" :["1.1"],
    "precision::eigs_iter_gain_policy" : ["VARSAT"],
    ...
    "strategy::trnc_decrease_when": ["SATURATED"],
    "strategy::trnc_decrease_rate": ["0.75"],
