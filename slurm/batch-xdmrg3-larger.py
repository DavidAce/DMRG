...
config_ranges = {
    ...
    "console::loglevel": ['2'],
    "precision::eigs_iter_min" :["2500"],
    "precision::eigs_iter_max" :["500000"],
    "precision::eigs_iter_gain" :["10.0"],
    "precision::eigs_iter_gain_policy" : ["SATURATED"],
    "precision::svd_truncation_min": ['1e-9'],
    "precision::svd_truncation_max": ['1e-6'],
    "precision::svd_switchsize_bdc": ['16'],
    "precision::variance_convergence_threshold": ['1e-12'],
    "strategy::iter_max_warmup": ['2'],
    "strategy::initial_state": ["PRODUCT_STATE_NEEL"],
    "strategy::dmrg_blocksize_policy": ["ICOM|STK_ALGO|FIN_BOND|FIN_TRNC"],
