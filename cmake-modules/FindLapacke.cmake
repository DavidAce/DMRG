    ...
    if (NOT TARGET lapacke::lapacke)
        ...
        if(TARGET mkl::mkl)
            ...
            if(LAPACKE_COMPILES)
                ...
                message(FATAL_ERROR "Intel MKL is expected to bundle Lapacke")
            endif()
        endif()
    endif()
    ...
    if (NOT TARGET lapacke::lapacke)
        if (TARGET openblas::openblas)
            ...
            if(LAPACKE_COMPILES)
                ...
                message(FATAL_ERROR "OpenBLAS is expected to bundle Lapacke")
            endif()
        endif()
    endif()
    ...
    if (NOT TARGET lapacke::lapacke)
        if(TARGET lapack::lapack)
            ...
            if(TARGET lapacke::lapacke)
                ...
                lapacke_message(STATUS "Looking for Lapacke in system - not found")
