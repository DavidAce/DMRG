...
function(find_Lapacke)
    ...
    if (NOT TARGET lapacke::lapacke)
        ...
        if(TARGET mkl::mkl)
            ...
            if(MKL_INCLUDE_DIR)
                CheckLapackeCompiles("mkl" "mkl::mkl" ""  ""  ""  "")
            endif()
...
#
    if (NOT TARGET lapacke::lapacke)
        if (TARGET openblas::openblas)
            ...
            if(LAPACKE_COMPILES)
                add_library("openblas" lapacke::lapacke INTERFACE IMPORTED)
    ...
    if (NOT TARGET lapacke::lapacke)
        if(TARGET lapack::lapack)
            ...
            CheckLapackeCompiles("system" "lapack::lapack" "${LAPACKE_LIBRARY}" "${LAPACKE_INCLUDE_DIR}" "" "")
            if(LAPACKE_COMPILES)
                if(LAPACKE_LIBRARY)
