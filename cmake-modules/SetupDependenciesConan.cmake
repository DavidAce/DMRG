...
if(DMRG_DOWNLOAD_METHOD MATCHES "conan")
    ...
    if(TARGET CONAN_PKG::spdlog)
        ...
        target_link_libraries(dmrg-eig PRIVATE CONAN_PKG::spdlog)
        target_link_libraries(dmrg-arp PRIVATE CONAN_PKG::spdlog)
    endif()
    ...
    if(TARGET CONAN_PKG::arpack++)
        target_link_libraries(dmrg-arp PRIVATE CONAN_PKG::arpack++)
    endif()
