...
if(DMRG_DOWNLOAD_METHOD MATCHES "conan")
    ...
    if(TARGET CONAN_PKG::h5pp)
        target_link_libraries(dmrg-main PRIVATE CONAN_PKG::h5pp)
    endif()
    if(TARGET CONAN_PKG::spdlog)
        target_link_libraries(dmrg-opt PRIVATE CONAN_PKG::spdlog)
    endif()
    if(TARGET CONAN_PKG::Eigen3)
        target_link_libraries(dmrg-main PRIVATE CONAN_PKG::Eigen3)
        target_link_libraries(dmrg-eig PRIVATE CONAN_PKG::Eigen3)
        target_link_libraries(dmrg-opt PRIVATE CONAN_PKG::Eigen3)
    elseif(TARGET CONAN_PKG::eigen)
        target_link_libraries(dmrg-main PRIVATE CONAN_PKG::eigen)
        target_link_libraries(dmrg-eig PRIVATE CONAN_PKG::eigen)
        target_link_libraries(dmrg-opt PRIVATE CONAN_PKG::eigen)
    endif()
    if(TARGET CONAN_PKG::ceres-solver)
        target_link_libraries(dmrg-opt PRIVATE CONAN_PKG::ceres-solver)
    endif()
    if(TARGET CONAN_PKG::arpack++)
        target_link_libraries(dmrg-eig PRIVATE CONAN_PKG::arpack++)
    endif()
    if(TARGET CONAN_PKG::openblas)
        target_link_libraries(dmrg-main PRIVATE CONAN_PKG::openblas)
        target_link_libraries(dmrg-eig PRIVATE CONAN_PKG::openblas)
    endif()
    if(TARGET mkl::mkl)
        target_link_libraries(dmrg-main PRIVATE  mkl::mkl)
        target_link_libraries(dmrg-eig PRIVATE  mkl::mkl)
    endif()
    ...
    if(TARGET Threads::Threads)
        target_link_libraries(dmrg-flags INTERFACE Threads::Threads)
    endif()
