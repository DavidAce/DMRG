...
#    endif()
    ...
    if(HDF5_IS_PARALLEL)
        ...
        message(WARNING "The HDF5 library is parallel and you are linking with -static.\n  OpenMPI will not like it.")
        target_link_libraries(hdf5 INTERFACE -lmpi -lopen-rte -lopen-pal -Wl,--whole-archive -libverbs -Wl,--no-whole-archive -lrt )
        else()
