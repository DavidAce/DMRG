...
#    endif()
    ...
    if(HDF5_IS_PARALLEL)
        if(HDF5_USE_STATIC_LIBRARIES)
            set(MPI_COMPILER_FLAGS -static-mpi)
            set(MPI_C_COMPILER_FLAGS -static-mpi)
        endif()
        find_package(MPI REQUIRED)
        target_link_libraries(hdf5 INTERFACE MPI::MPI_C -static-mpi  )
        get_target_property(MPI_LIB MPI::MPI_C INTERFACE_LINK_LIBRARIES)
        message("Adding MPI Library: ${MPI_LIB}")
