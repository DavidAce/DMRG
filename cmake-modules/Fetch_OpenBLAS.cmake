...
if(BLAS_openblas_LIBRARY)
    ...
    ExternalProject_Add(library_OpenBLAS
            ...
            CONFIGURE_COMMAND ""
            BUILD_IN_SOURCE 1
            BUILD_COMMAND $(MAKE) "USE_THREAD=${OpenBLAS_MULTITHREADED} USE_OPENMP=${OpenBLAS_USE_OPENMP} GEMM_MULTITHREADING_THRESHOLD=50 NO_AFFINITY=1 INTERFACE64=0 OPENBLAS_NUM_THREADS=8 NUM_THREADS=8 BINARY64=1 QUIET_MAKE=1 TARGET=${OPENBLAS_MARCH}"
