...
elseif (DOWNLOAD_SPDLOG OR DOWNLOAD_ALL)
    ...
    set(spdlog_DIR ${INSTALL_DIR}/spdlog/${CMAKE_INSTALL_LIBDIR}/spdlog/cmake)
    add_dependencies(spdlog external_SPDLOG)
    target_include_directories(spdlog INTERFACE ${INSTALL_DIR}/${CMAKE_INSTALL_INCLUDEDIR})
    target_link_libraries(spdlog INTERFACE ${INSTALL_DIR}/${CMAKE_INSTALL_LIBDIR}/spdlog/libspdlog${CUSTOM_SUFFIX})
