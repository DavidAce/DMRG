...
function(print_target_info target_name prefix)
    if(TARGET ${target_name})
        ...
        if(TYPE_TGT MATCHES "STATIC|SHARED|UNKNOWN" AND NOT TYPE_TGT MATCHES "INTERFACE")
            get_target_property(INFO_LOC  ${target_name} LOCATION)
        endif()
        if(TYPE_TGT MATCHES "STATIC|SHARED|UNKNOWN|OBJECT|EXECUTABLE" AND NOT TYPE_TGT MATCHES "INTERFACE")
