...
#        print_target_properties(${target_name})
        if(NOT TYPE_TGT MATCHES "INTERFACE" AND NOT TYPE_TGT MATCHES "EXECUTABLE")
            get_target_property(INFO_IMP_ALL  ${target_name} IMPORTED_LOCATION)
            get_target_property(INFO_IMP_REL  ${target_name} IMPORTED_LOCATION_RELEASE)
            get_target_property(INFO_IMP_DEB  ${target_name} IMPORTED_LOCATION_DEBUG)
            get_target_property(INFO_IMP_NOC  ${target_name} IMPORTED_LOCATION_NOCONFIG)
            get_target_property(INFO_IMP_LIB  ${target_name} IMPORTED_LINK_INTERFACE_LIBRARIES)
            get_target_property(INFO_IMP_LOC  ${target_name} LOCATION)
            get_target_property(INFO_IMP_LOT  ${target_name} LOCATION_${CMAKE_BUILD_TYPE})


#            message("${INFO_IMP} ${INFO_IMP_REL} ${INFO_IMP_DEB} ${INFO_IMP_NOC} ")
            if(INFO_IMP_ALL)
                list(APPEND INFO_IMP ${INFO_IMP_ALL})
            endif()
            if(INFO_IMP_REL)
                list(APPEND INFO_IMP ${INFO_IMP_REL} )
            endif()
            if(INFO_IMP_DEB)
                list(APPEND INFO_IMP ${INFO_IMP_DEB} )
            endif()
            if(INFO_IMP_NOC)
                list(APPEND INFO_IMP ${INFO_IMP_NOC} )
            endif()
            if(INFO_IMP_LIB)
                list(APPEND INFO_IMP ${INFO_IMP_LIB} )
            endif()
            if(INFO_IMP_LOC)
                list(APPEND INFO_IMP ${INFO_IMP_LOC} )
            endif()
            if(INFO_IMP_LOT)
                list(APPEND INFO_IMP ${INFO_IMP_LOT} )
            endif()
        endif()
