if(NOT TARGET h5pp::h5pp AND DMRG_DOWNLOAD_METHOD STREQUAL "find")
    find_package(h5pp 1.7.1 QUIET NO_CMAKE_PACKAGE_REGISTRY)
...
if(NOT TARGET h5pp::h5pp AND DMRG_DOWNLOAD_METHOD MATCHES "fetch")
    ...
    if(TARGET Eigen3::Eigen)
        ...
        list(APPEND H5PP_CMAKE_OPTIONS  -DEIGEN3_INCLUDE_DIR:PATH=${EIGEN3_INCLUDE_DIR})
    endif()
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_DIRECTORY_HINTS:PATH=${CMAKE_INSTALL_PREFIX})
    list(APPEND H5PP_CMAKE_OPTIONS  -DEIGEN3_DIRECTORY_HINTS:PATH=${CMAKE_INSTALL_PREFIX}/Eigen3)
    list(APPEND H5PP_CMAKE_OPTIONS  -DEIGEN3_INCLUDE_DIR:PATH=${CMAKE_INSTALL_PREFIX}/Eigen3/include)
