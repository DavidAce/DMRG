...
find_package(h5pp 0.4.7 HINTS ${CMAKE_INSTALL_PREFIX} ${CONDA_HINTS} PATHS ${CMAKE_INSTALL_PREFIX}   PATH_SUFFIXES h5pp)
...
elseif(NOT ${DOWNLOAD_METHOD} MATCHES "none")
    ...
    find_package(h5pp  0.4.7 HINTS ${CMAKE_INSTALL_PREFIX} PATHS PATH_SUFFIXES h5pp)
    if(h5pp_FOUND AND TARGET h5pp::h5pp)
    ...
    message(FATAL_ERROR "Dependency h5pp not found and DOWNLOAD_METHOD = ${DOWNLOAD_METHOD}")
endif()
