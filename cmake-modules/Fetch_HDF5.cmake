...
if (EXISTS "$ENV{HDF5_DIR}")
    ...
    set(HDF5_LINKER_FLAGS      -Wl,--no-as-needed -ldl -lm -lz -Wl,--whole-archive -lpthread -Wl,--no-whole-archive )
#    if (HDF5_IS_PARALLEL)
...
#    message("HDF5 C compiler wrapper             : ${HDF5_C_COMPILER_EXECUTABLE}")
    ...
    set(HDF5_LINKER_FLAGS       -Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,--whole-archive -lpthread -Wl,--no-whole-archive -lz -ldl -lm)
...
#    endforeach()
    ...
    add_dependencies(hdf5::hdf5_cpp      external_HDF5)
    add_dependencies(hdf5::hdf5_hl_cpp   external_HDF5)
    ...
    set(HDF5_LINKER_FLAGS      -Wl,--no-as-needed -ldl -lm -lz -Wl,--whole-archive -lpthread -Wl,--no-whole-archive )
#    set(HDF5_LINKER_FLAGS     -Wl,--whole-archive -lpthread -Wl,--no-whole-archive -ldl -lm)
