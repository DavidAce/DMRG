...
function(find_Arpackpp)
    ...
    if (NOT TARGET arpack::arpack++)
        ...
        if(ARPACKPP_INCLUDE_DIR)
            CheckArpackppCompiles("header_only" "-std=c++17"  ""  "" "${ARPACKPP_INCLUDE_DIR}" "arpack::arpack;lapacke::lapacke")
    ...
    if(NOT TARGET arpack::arpack++)
        ...
        if(ARPACKPP_LIBRARIES AND ARPACKPP_INCLUDE_DIR)
            CheckArpackppCompiles("lib" "-std=c++17"  ""  "${ARPACKPP_LIBRARIES}" "${ARPACKPP_INCLUDE_DIR}" "arpack::arpack;lapacke::lapacke")
