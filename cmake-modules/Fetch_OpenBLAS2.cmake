...
elseif(DOWNLOAD_MISSING)
    ...
    set(LDFLAGS "-L${GFORTRAN_PATH} ${GFORTRAN_LIB} ${QUADMATH_LIB}")
    ...
    list(APPEND OpenBLAS_CMAKE_OPTIONS  -DUSE_THREAD:STRING=${OpenBLAS_MULTITHREADED})
    list(APPEND OpenBLAS_CMAKE_OPTIONS  -DUSE_OPENMP:STRING=${OpenBLAS_ENABLE_OPENMP})
    ...
    build_dependency(OpenBLAS "${OpenBLAS_CMAKE_OPTIONS}")
    find_OpenBLAS()
    if(TARGET OpenBLAS)
