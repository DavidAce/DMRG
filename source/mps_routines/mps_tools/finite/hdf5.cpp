...
void MPS_Tools::Finite::Hdf5::write_all(class_finite_chain_state & state, class_hdf5_file & hdf5, std::string sim_name) {
    ...
    write_entanglement(state,hdf5,sim_name);
...
void MPS_Tools::Finite::Hdf5::write_entanglement(class_finite_chain_state & state, class_hdf5_file & hdf5, std::string sim_name){
