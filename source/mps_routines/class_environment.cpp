...
template<Side side>
void class_environment_var<side>::enlarge(const class_mps &MPS, const Tensor<Scalar,4> &M){
    /*!< Contracts a site into the block. */
...
template class class_environment_var<Side::L>;
template class class_environment_var<Side::R>;