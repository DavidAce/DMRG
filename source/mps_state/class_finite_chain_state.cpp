...
class_vidal_site & class_finite_chain_state::get_MPS(size_t pos){
    return const_cast<class_vidal_site &>(static_cast<const class_finite_chain_state &>(*this).get_MPS(pos));
}
...
class_hamiltonian_base & class_finite_chain_state::get_MPO(size_t pos){
    return const_cast<class_hamiltonian_base &>(static_cast<const class_finite_chain_state &>(*this).get_MPO(pos));
}
...
Eigen::Tensor<class_finite_chain_state::Scalar,3> & class_finite_chain_state::get_G(size_t pos){
    return const_cast<Eigen::Tensor<class_finite_chain_state::Scalar,3> &>(static_cast<const class_finite_chain_state &>(*this).get_G(pos));
}
...
Eigen::Tensor<class_finite_chain_state::Scalar,1> & class_finite_chain_state::get_L(size_t pos) {
    return const_cast<Eigen::Tensor<class_finite_chain_state::Scalar,1> &>(static_cast<const class_finite_chain_state &>(*this).get_L(pos));
}
...
const class_environment & class_finite_chain_state::get_ENVL(size_t pos) const {
...
const class_environment_var & class_finite_chain_state::get_ENV2L(size_t pos) const {
...
std::list<size_t> class_finite_chain_state::activate_sites(long threshold){
