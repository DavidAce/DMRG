...
class MpsSite {
    ...
    std::optional<Eigen::Tensor<cplx, 1>>                L                   = std::nullopt; /*!< \f$\Lambda\f$*/
    ...
    mutable std::optional<stash<Eigen::Tensor<cplx, 1>>> S_stash = std::nullopt; /*!< \f$S\f$ A "S" matrix from SVD stored temporarily  */
    mutable std::optional<stash<Eigen::Tensor<cplx, 1>>> C_stash = std::nullopt; /*!< \f$S\f$ A "C" matrix from SVD stored temporarily  */
    mutable std::optional<stash<Eigen::Tensor<cplx, 3>>> V_stash = std::nullopt; /*!< \f$V\f$ A "V" matrix from SVD stored temporarily  */
    ...
    [[nodiscard]] const Eigen::Tensor<cplx, 3> &get_M_bare() const; /*!< Gets the A or B matrix without LC attached */
    [[nodiscard]] const Eigen::Tensor<cplx, 3> &get_M() const;      /*!< Gets A or B matrix. If this is a center (A matrix) it attaches LC */
    [[nodiscard]] const Eigen::Tensor<cplx, 1> &get_L() const;
    [[nodiscard]] const Eigen::Tensor<cplx, 1> &get_LC() const;
    [[nodiscard]] Eigen::Tensor<cplx, 3>       &get_M_bare();
    [[nodiscard]] Eigen::Tensor<cplx, 3>       &get_M();
    [[nodiscard]] Eigen::Tensor<cplx, 1>       &get_L();
    [[nodiscard]] Eigen::Tensor<cplx, 1>       &get_LC();
    ...
    std::optional<stash<Eigen::Tensor<cplx, 1>>> &get_S_stash() const;
