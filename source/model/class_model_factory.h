...
class class_model_factory {
    public:
    static std::unique_ptr<class_model_base> create_mpo(size_t position, std::string_view model_type_str);

    template<typename... T>
    static std::unique_ptr<class_model_base> create_mpo(size_t position, std::string_view model_type_str, T... args) {
