...
//        inline int stl_threads = 1;                                              /*!< Number of threads for c++11 threading. Used in Eigen::Tensor. stl_threads <= 0 will try to use as many as possible */
    ...
    namespace strategy {
        ...
        inline BlockSizePolicy     dmrg_blocksize_policy       = BlockSizePolicy::MINDEF;                   /*!< Bitflag to control the adaptive dmrg blocksize {MIN, MAX, MAXVARSAT, MAXSTUCK, INFO, INFOVARSAT, INFOSTUCK} */
