...
void settings::load(Loader &dmrg_config) {
    ...
    dmrg_config.load_parameter("storage::mps::state_emax::level"                            , storage::mps::state_emax::level);
    dmrg_config.load_parameter("storage::mps::state_emax::policy"                           , storage::mps::state_emax::policy);
    dmrg_config.load_parameter("storage::mps::state_real::level"                            , storage::mps::state_real::level);
    dmrg_config.load_parameter("storage::mps::state_real::policy"                           , storage::mps::state_real::policy);
    dmrg_config.load_parameter("storage::mps::state_lbit::level"                            , storage::mps::state_lbit::level);
    dmrg_config.load_parameter("storage::mps::state_lbit::policy"                           , storage::mps::state_lbit::policy);
    dmrg_config.load_parameter("storage::mps::state_proj::level"                            , storage::mps::state_proj::level);
    dmrg_config.load_parameter("storage::mps::state_bond::level"                            , storage::mps::state_bond::level);
    dmrg_config.load_parameter("storage::mps::state_fes::level"                             , storage::mps::state_fes::level);
    dmrg_config.load_parameter("storage::mpo::model::level"                                 , storage::mpo::model::level);
    ...
    dmrg_config.load_parameter("storage::table::correlation_matrix_spin_xyz::policy"        , storage::table::correlation_matrix_spin_xyz::policy);
    dmrg_config.load_parameter("storage::table::random_unitary_circuit::policy"             , storage::table::random_unitary_circuit::policy);
    dmrg_config.load_parameter("storage::dataset::lbit_analysis::level"                     , storage::dataset::lbit_analysis::level);
    dmrg_config.load_parameter("storage::dataset::lbit_analysis::policy"                    , storage::dataset::lbit_analysis::policy);
    dmrg_config.load_parameter("storage::dataset::subsystem_entropies::policy"              , storage::dataset::subsystem_entropies::policy);
    dmrg_config.load_parameter("storage::dataset::subsystem_entropies::chunksize"           , storage::dataset::subsystem_entropies::chunksize);
    ...
    dmrg_config.load_parameter("precision::use_mpo_parity_shift"              , precision::use_mpo_parity_shift);
