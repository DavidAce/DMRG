...
void settings::load_config(class_dmrg_config &dmrg_config) {
    ...
    dmrg_config.load_parameter<double>                  ("model::ising_tf_rf_nn::J1"                    , model::ising_tf_rf_nn::J1);
    dmrg_config.load_parameter<double>                  ("model::ising_tf_rf_nn::J2"                    , model::ising_tf_rf_nn::J2);
    dmrg_config.load_parameter<double>                  ("model::ising_tf_rf_nn::h_tran"                , model::ising_tf_rf_nn::h_tran);
    dmrg_config.load_parameter<double>                  ("model::ising_tf_rf_nn::h_mean"                , model::ising_tf_rf_nn::h_mean);
    dmrg_config.load_parameter<double>                  ("model::ising_tf_rf_nn::h_stdv"                , model::ising_tf_rf_nn::h_stdv);
    dmrg_config.load_parameter<size_t>                  ("model::ising_tf_rf_nn::spin_dim"              , model::ising_tf_rf_nn::spin_dim);
    dmrg_config.load_parameter<std::string>             ("model::ising_tf_rf_nn::distribution"          , model::ising_tf_rf_nn::distribution);
    dmrg_config.load_parameter<double>                  ("model::ising_selfdual_tf_rf_nn::J_mean"       , model::ising_selfdual_tf_rf_nn::J_mean);
    dmrg_config.load_parameter<double>                  ("model::ising_selfdual_tf_rf_nn::h_mean"       , model::ising_selfdual_tf_rf_nn::h_mean);
    dmrg_config.load_parameter<double>                  ("model::ising_selfdual_tf_rf_nn::J_stdv"       , model::ising_selfdual_tf_rf_nn::J_stdv);
    dmrg_config.load_parameter<double>                  ("model::ising_selfdual_tf_rf_nn::h_stdv"       , model::ising_selfdual_tf_rf_nn::h_stdv);
    dmrg_config.load_parameter<double>                  ("model::ising_selfdual_tf_rf_nn::lambda"       , model::ising_selfdual_tf_rf_nn::lambda);
    dmrg_config.load_parameter<bool>                    ("model::ising_selfdual_tf_rf_nn::parity_sep"   , model::ising_selfdual_tf_rf_nn::parity_sep);
    dmrg_config.load_parameter<std::string>             ("model::ising_selfdual_tf_rf_nn::distribution" , model::ising_selfdual_tf_rf_nn::distribution);
    dmrg_config.load_parameter<size_t>                  ("model::ising_selfdual_tf_rf_nn::spin_dim"     , model::ising_selfdual_tf_rf_nn::spin_dim);
