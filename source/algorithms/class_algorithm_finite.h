...
class class_algorithm_finite : public class_algorithm_base {
    ...
    size_t max_stuck_iters      = 25; //  5;  /*!< If stuck for this many sweeps -> stop. */
    size_t min_saturation_iters = 5;  // 1;  /*!< If both var and ent saturated  this long -> got_stuck: true */
    size_t max_saturation_iters = 35; // 10; /*!< If either var or ent saturated this long -> got_stuck: true Requires var and ent stuck for > 0 */
