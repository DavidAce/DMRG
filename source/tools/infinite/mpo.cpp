...
void tools::infinite::mpo::initialize(class_infinite_state & state, std::string model_type){
...
void tools::infinite::mpo::randomize(class_infinite_state &state, int seed_model) {
