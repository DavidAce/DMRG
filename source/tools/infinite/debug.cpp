...
void tools::infinite::debug::check_integrity([[maybe_unused]] const class_model_infinite &model) { tools::log->debug("Checking integrity of model"); }

void tools::infinite::debug::check_integrity([[maybe_unused]] const class_edges_infinite &edges) { tools::log->debug("Checking integrity of edges"); }
