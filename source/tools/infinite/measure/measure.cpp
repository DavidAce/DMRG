...
double tools::infinite::measure::energy_minus_energy_reduced(const state_or_mps_type &state, const ModelInfinite &model, const EdgesInfinite &edges) {
...
template double tools::infinite::measure::energy_minus_energy_reduced(const StateInfinite &, const ModelInfinite &model, const EdgesInfinite &edges);
template double tools::infinite::measure::energy_minus_energy_reduced(const Eigen::Tensor<Scalar, 3> &, const ModelInfinite &model, const EdgesInfinite &edges);
