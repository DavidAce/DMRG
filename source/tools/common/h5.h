...
namespace tools::common::h5 {
    ...
    namespace resume{
        ...
        extern std::string             find_resumable_state     (const h5pp::File & h5file, AlgorithmType algo_type, std::string_view  search = "");
    }
    namespace save{
        ...
        extern void attr     (h5pp::File & h5file, const AttrType &attrData, std::string_view attrName, std::string_view linkPath, std::string_view linkText);
