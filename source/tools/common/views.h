...
namespace tools::common::views {
    ...
    extern Eigen::Tensor<Scalar,4> get_theta_swapped               (const class_state_infinite & state, Scalar norm = 1.0);              /*!< Returns rank 4 tensor \f$\Theta\f$, with A and B swapped.*/
    ...
    extern Eigen::Tensor<Scalar,4> get_theta_odd                   (const class_state_infinite & state, Scalar norm = 1.0);              /*!< Returns rank 4 tensor \f$\Theta\f$, with A and B swapped.*/
    ...
    extern Eigen::Tensor<Scalar,4> get_theta_swapped               (const class_mps_2site  &MPS, Scalar norm = 1.0);              /*!< Returns rank 4 tensor \f$\Theta\f$, with A and B swapped.*/
    extern Eigen::Tensor<Scalar,4> get_theta_evn                   (const class_mps_2site  &MPS, Scalar norm = 1.0);              /*!< Returns rank 4 tensor \f$\Theta\f$.*/
    extern Eigen::Tensor<Scalar,4> get_theta_odd                   (const class_mps_2site  &MPS, Scalar norm = 1.0);              /*!< Returns rank 4 tensor \f$\Theta\f$, with A and B swapped.*/
