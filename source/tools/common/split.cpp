...
template std::vector<MpsSite> tools::common::split::internal::split_mps_into_As2(const Eigen::Tensor<real, 3> &multisite_mps,
                                                                                 ...
                                                                                 long chi_limit, std::optional<svd::settings> svd_settings);
...
template std::deque<MpsSite> tools::common::split::internal::split_mps_into_Bs2(const Eigen::Tensor<real, 3> &multisite_mps, const std::vector<long> &spin_dims,
                                                                                const std::vector<size_t> &positions, long chi_limit,
                                                                                std::optional<svd::settings> svd_settings);
template std::deque<MpsSite> tools::common::split::internal::split_mps_into_Bs2(const Eigen::Tensor<cplx, 3> &multisite_mps, const std::vector<long> &spin_dims,
                                                                                const std::vector<size_t> &positions, long chi_limit,
                                                                                std::optional<svd::settings> svd_settings);