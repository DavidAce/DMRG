...
void tools::common::io::h5attr::write_meta(h5pp::File &h5ppFile, const std::string &sim_name, const std::string &state_prefix, const std::string &model_prefix,
                                           ModelType model_type, const StorageLevel &storage_level, const class_simulation_status &sim_status) {
    ...
    tools::log->trace("Attribute -- {: <30} = {: <30} on dset: {}", "iteration", sim_status.iter, state_prefix);
    tools::log->trace("Attribute -- {: <30} = {: <30} on dset: {}", "step", sim_status.step, state_prefix);
    tools::log->trace("Attribute -- {: <30} = {: <30} on dset: {}", "position", sim_status.position, state_prefix);
