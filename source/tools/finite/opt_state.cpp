...
opt_state::opt_state(const std::string &name_, const Eigen::Tensor<cplx, 3> &tensor_, const std::vector<size_t> &sites_, double eigval_,
...
double opt_state::get_energy_per_site() const {
...
double opt_state::get_variance_per_site() const {
...
void opt_state::set_eigval(double eigval_) { eigval = eigval_; }
void opt_state::set_energy_reduced(double energy_reduced_) { energy_r = energy_reduced_; }
void opt_state::set_energy(double energy_) { energy = energy_; }
