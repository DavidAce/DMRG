...
tools::finite::opt::opt_mps tools::finite::opt::internal::primme_variance_optimization(const class_tensors_finite &tensors, const opt_mps &initial_mps,
    ...
    //    internal::primme_extract_solutions(initial_mps, tensors, solver_shft2, eigvecs_mps, "shifted2");
    //    internal::primme_extract_solutions(initial_mps, tensors, solver_shft3, eigvecs_mps, "shifted3");
