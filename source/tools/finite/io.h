...
namespace tools::finite::io {
    ...
    namespace h5dset{
        ...
        extern void write_measurements   (h5pp::File & h5ppFile, const std::string & state_prefix, const StorageLevel & storage_level, const class_state_finite & state);
    }
    ...
    namespace h5table{
        ...
        extern void write_measurements         (h5pp::File & h5ppFile, const std::string & state_prefix, const StorageLevel & storage_level, const class_state_finite & state, const class_simulation_status & sim_status);
    ...
    namespace h5resume{
        ...
        extern std::vector<ResumeReason>
            findResumeReasons(const h5pp::File &h5ppFile, const std::string &sim_name, const std::string &state_prefix, const class_state_finite & state, const class_simulation_status & sim_status);
