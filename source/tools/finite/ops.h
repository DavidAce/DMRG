...
namespace tools::finite::ops {
    ...
    extern void project_to_nearest_sector                   (StateFinite & state, std::string_view sector, std::optional<long> bond_limit, std::optional<svd::settings> svd_settings = std::nullopt);
    ...
    [[nodiscard]] extern
    StateFinite get_projection_to_sector                    (const StateFinite & state, const Eigen::MatrixXcd & paulimatrix, int sign, std::optional<long> bond_limit, std::optional<svd::settings> svd_settings = std::nullopt);
    [[nodiscard]] extern
    StateFinite get_projection_to_nearest_sector            (const StateFinite & state, std::string_view  sector, std::optional<long> bond_limit, std::optional<svd::settings> svd_settings = std::nullopt);
