...
namespace tools::finite::ops {
    ...
    extern class_state_finite
        get_projection_to_sector              (const class_state_finite & state, const Eigen::MatrixXcd & paulimatrix, int sign);
    extern class_state_finite
        get_projection_to_nearest_sector      (const class_state_finite & state, const std::string &sector);
    extern void  project_to_nearest_sector    (class_state_finite & state, const std::string &sector);
    extern void  project_to_sector            (class_state_finite & state, const std::string &sector);
