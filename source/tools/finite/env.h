...
namespace tools::finite::env {
    extern std::vector<size_t> expand_environment_backward(StateFinite &state, const ModelFinite &model, EdgesFinite &edges, std::optional<double> alpha,
                                                  EnvExpandMode envExpandMode, std::optional<svd::config> svd_cfg = std::nullopt);
    extern std::vector<size_t> expand_environment_forward(StateFinite &state, const ModelFinite &model, EdgesFinite &edges, std::optional<double> alpha,
                                              EnvExpandMode envExpandMode, std::optional<svd::config> svd_cfg = std::nullopt);
