...
namespace tools::finite::multisite {
    extern Eigen::DSizes<long, 3> get_dimensions(const class_state_finite &state, std::optional<std::list<size_t>> active_sites);
    extern Eigen::DSizes<long, 4> get_dimensions(const class_model_finite &model, std::optional<std::list<size_t>> active_sites);
