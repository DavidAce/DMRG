...
namespace tools::finite::multisite {
    ...
    extern std::vector<size_t> generate_site_list_old(StateFinite &state, long threshold, size_t max_sites, size_t min_sites = 1, const std::string &tag = "");
    extern std::vector<size_t> generate_truncated_site_list(StateFinite &state, long threshold, long bond_lim, size_t max_sites, size_t min_sites = 1);
