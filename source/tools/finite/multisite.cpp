...
std::vector<size_t> tools::finite::multisite::generate_truncated_site_list(class_state_finite &state, long threshold, long chi_lim, const size_t max_sites, const size_t min_sites){
