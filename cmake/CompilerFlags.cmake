...
set(${PROJECT_UNAME}_MTUNE znver2  CACHE STRING "CPU micro-architecture")
...
target_compile_options(dmrg-flags INTERFACE -g -fno-strict-aliasing -fdiagnostics-color=always -Wall -Wpedantic -Wextra -Wconversion -Wunused)
target_compile_options(dmrg-flags INTERFACE $<$<CONFIG:RELEASE>:${MARCH} ${MTUNE} -ffp-contract=fast>)
target_compile_options(dmrg-flags INTERFACE $<$<CONFIG:DEBUG>: -fno-omit-frame-pointer -fstack-protector -D_FORTIFY_SOURCE=2>)
target_compile_options(dmrg-flags INTERFACE $<$<AND:$<CONFIG:DEBUG>,$<CXX_COMPILER_ID:Clang>>: -fstandalone-debug>)
target_compile_options(dmrg-flags INTERFACE $<$<CONFIG:RELWITHDEBINFO>:-O3 ${MARCH} ${MTUNE}>)
target_compile_options(dmrg-flags INTERFACE $<$<AND:$<CONFIG:RELWITHDEBINFO>,$<CXX_COMPILER_ID:Clang>>: -fstandalone-debug>)

target_compile_options(dmrg-flags INTERFACE $<$<CONFIG:MINSIZEREL>:>)
