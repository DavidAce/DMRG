...
function(remove_empty_genexpr list_data)
    string(REPLACE ":;>" ":>;" ${list_data} "${${list_data}}")
    string(REPLACE ";;" ";" ${list_data} "${${list_data}}")
    foreach (elem ${${list_data}})
        if (elem MATCHES "<CONFIG:${CMAKE_BUILD_TYPE}")
            message(STATUS "Appending (${CMAKE_BUILD_TYPE}): ${elem}")
            list(APPEND match_list ${elem})
        elseif (elem MATCHES "<CONFIG:")
            message(STATUS "Discarding (${CMAKE_BUILD_TYPE}): ${elem}")
            continue()
        else ()
            #            message(STATUS "Appending (${CMAKE_BUILD_TYPE}): ${elem}")
            list(APPEND match_list ${elem})
