...
function(conan_install)
    ...
    if (NOT "${return_code}" STREQUAL "0")
        ...
        set(CONAN_GENERATORS_FOLDER "${CONAN_OUTPUT_FOLDER}")
        message(STATUS "cmake-conan: CONAN_GENERATORS_FOLDER=${CONAN_OUTPUT_FOLDER}")
        message(STATUS "cmake-conan:\n${conan_stdout}")
...
function(conan_provide_dependency package_name)
    ...
    if (NOT CONAN_GENERATORS_FOLDER IN_LIST CMAKE_PREFIX_PATH)
