...
def get_meta(plotdir, cachedir):
    ...
    meta = {
        ...
        'pin-lnlnt': {  # Number probabilities p_i(n) at i = L/2
            'default': default,
            ...
            # 'xmax': 3.1,
            'shadowoffset': (-0.35, -0.35),
            'plotprefix': 'pin-lnlnt',
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename': 'pin-lnlnt-f0.2',
            'findsaturation': True,  # Instead of taking the last value, take the average of the plateau
        ...
        'qin-lnlnt': {  # Number probabilities p_i(n) at i = L/2
            'default': default,
            'groupname': 'nth_particle_position',
            'dsetname': 'qin_probability',
            'normpage': False,
            # 'titlename': 'Number Entropy Approach to saturation',
            'ylabel': '$|\overline S_\mathrm{N}^\infty - \overline S_\mathrm{N}|$',
            'xlabel': '$\ln \ln t$',
            ...
            # 'xmax': 3.1,
            'shadowoffset': (-0.35, -0.35),
            'plotprefix': 'qin-lnlnt',
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename': 'qin-lnlnt-f0.2',
            'findsaturation': True,  # Instead of taking the last value, take the average of the plateau
            'markerlist': ['growth-begin', 'num-saturated', ],
            'findloglogwindow': False,
            'markloglogwindow': False,
