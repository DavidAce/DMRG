...
def get_meta(plotdir):
    ...
    meta = {
        ...
        'tavg-ent': {
            ...
            # 'figsize': (3.375, 3.00),
            'ylabel': '$\langle S_\mathrm{E}^\infty \\rangle$',
            'yformat': '%.2f',
        ...
        'tgvg-ent': {
            ...
            # 'titlename': 'Average Entanglement entropy as $t\\rightarrow \infty$',
            # 'figsize': (3.375, 3.00),
            'ylabel': '$\langle S_\mathrm{E}^\infty \\rangle_\mathrm{geom.}$',
            'yformat': '%.2f',
            'xticks': [12, 16, 20, 24, 28, 32],
            # 'xmaloc': MaxNLocator(integer=True),
            'sharex': 'all',
        ...
        'tavg-num': {
            ...
            # 'figsize': (3.375, 3.00),
            'ylabel': '$\langle S_\mathrm{N}^\infty\\rangle$',
            'yformat': '%.2f',
            'xticks': [12, 16, 20, 24, 28, 32],
        ...
        'tgvg-num': {
            ...
            # 'titlename': 'Average Number Entropy as $t\\rightarrow \infty$',
            # 'figsize': (3.375, 3.00),
            'ylabel': '$\langle S_\mathrm{N}^\infty\\rangle_\mathrm{geom.}$',
            'yformat': '%.2f',
            'xticks': [12, 16, 20, 24, 28, 32],
            # 'xmaloc': MaxNLocator(integer=True, nbins=4),
            'sharex': 'all',
