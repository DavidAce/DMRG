...
def get_meta(plotdir):
    ...
    meta = {
        ...
        'num-lnt-norm': {
            ...
            'normsinf': True,
            # 'titlename': 'Number Entropy',
            'ylabel': '$\overline S_N / S_N^\infty$',
            'xlabel': '$\ln t  / (S_E^\infty / S_\mathrm{Page})$',
            'sharex': 'None',
            'yformat': '%.3f',
            # 'yscale': 'log',
            # 'xscale': 'log',
        ...
        'num-se-norm': {
            ...
            # 'titlename': 'Number Entropy',
            'ylabel': '$\overline S_N / S_N^\infty$',
            'xlabel': '$\overline S_E / (S_E^\infty / S_\mathrm{Page})$',
            'sharex': 'None',
            'yformat': '%.3f',
            # 'yscale': 'log',
            # 'xscale': 'log',
        ...
        'num-lnlnt-norm': {
            ...
            # 'titlename': 'Number Entropy',
            'ylabel': '$\overline S_N / S_N^\infty$',
            'xlabel': '$\ln\ln t / (S_E^\infty / S_\mathrm{Page})$',
            'sharey': 'None',
            'sharex': 'all',
            'yformat': '%.3f',
            # 'yscale': 'log',
        ...
        'num2-med': {
            ...
            'xlabel': '$\ln\ln t$',
            'ylabel': '$\langle\langle S_N\\rangle \\rangle_\mathrm{median}$',
            'yformat': '%.3f',
            'ystat' : 'med',
            # 'yscale': 'log',
            'plotprefix': 'SN',
        ...
        'num2-typ': {
            ...
            'xlabel': '$\ln\ln t$',
            'ylabel': '$\langle\langle S_N\\rangle \\rangle_\mathrm{typical}$',
            'yformat': '%.3f',
            'ystat': 'typ',
            # 'yscale': 'log',
            'plotprefix': 'SN',
        ...
        'lbit-typ': {
            ...
            'ylabel': '$\log_{10} \\tilde O_{ij}_\mathrm{geometric}$ ',
            'xlabel': "$j$",
            'xticks': [0, 6, 12, 18] if prb else None,
            # 'yticks': [1e0, 1e-4, 1e-9],
            'yticks': [0, -3, -6, -9, -12, -15],
        ...
        'pivg-num': {  # Distribution of infinite time averaged entropy
            ...
            # 'figsize': (3.375, 3.00),
            'ylabel': '$p\left[S(p_N^\infty)\\right]$',
            'yscale': 'log',
            # 'yformat': '%.2f',
            'ymaloc': LogLocator(numticks=9),  # FixedLocator([1e-3,1e-2,1e-1,1e0,1e1]),
            # 'ymafmt': LogFormatterMathtext(labelOnlyBase=True),
