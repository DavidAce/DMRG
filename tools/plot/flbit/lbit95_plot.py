...
from plotting.meta95_prb import *
    ...
    for batch in batches:
        ...
        if batchglob:
            ...
            for avgfile in [f'{batchdir}/analysis/data/averaged.h5',
                            # f'{projdir}/lbit94-precision/analysis/data/averaged.h5',
                            f'{projdir}/lbit94-eps1e-8/analysis/data/averaged.h5',
                            ]:
